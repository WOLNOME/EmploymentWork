...
JudgePlayerPreDistanceLeaf::JudgePlayerPreDistanceLeaf(int _nodeID, BlackBoard* _blackBoard, float _distance) : LeafNodeBase(_nodeID, _blackBoard), distance_(_distance) {
}
