...
//アプリケーション
#include <application/object/character/item/key/collision/ItemKeyCollider.h>
...
void ItemKey::Spawn(const Vector3& _initPos) {
	//初期座標を保存
...
void ItemKey::UntilDeathProcess() {
	//共通処理
	{
		// タイマー更新
