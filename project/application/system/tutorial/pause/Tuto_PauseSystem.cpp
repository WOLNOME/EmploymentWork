	...
	//メニューの文字の生成・初期化
	{
		...
		for (int i = 0; i < kMaxStringNum_; i++) {
			...
			case 2: {
				...
				stringMenuSprite_[i]->SetPosition({ WinApp::kClientWidth / 2.0f, 450.0f });
				break;
			}
			case 3: {
				// 移動チュートリアル
				...
				stringMenuSprite_[i]->SetPosition({ WinApp::kClientWidth / 2.0f, 510.0f });
				break;
			}
			case 4: {
				// 攻撃チュートリアル
				...
				stringMenuSprite_[i]->SetPosition({ WinApp::kClientWidth / 2.0f, 570.0f });
				break;
			}
			case 5: {
				// タイトルへ
				...
				stringMenuSprite_[i]->SetPosition({ WinApp::kClientWidth / 2.0f, 630.0f });
				break;
			}
			default:
				break;
